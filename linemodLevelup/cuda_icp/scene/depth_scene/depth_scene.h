...
struct Scene_projective{
    ...
    void init_Scene_projective_cpu(cv::Mat& scene_depth, Mat3x3f& scene_K, Scene_proj_buffer_cpu& scene_buffer);

#ifdef CUDA_ON
    void init_Scene_projective_cuda(cv::Mat& scene_depth, Mat3x3f& scene_K, Scene_proj_buffer_cuda& scene_buffer);
#endif
